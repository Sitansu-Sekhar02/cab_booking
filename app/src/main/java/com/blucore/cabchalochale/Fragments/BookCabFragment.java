...
import com.blucore.cabchalochale.Activity.GPSTracker;
import com.blucore.cabchalochale.Activity.MainActivity;
import com.blucore.cabchalochale.Activity.Utils;
import com.blucore.cabchalochale.Model.CabBookingModel;
import com.blucore.cabchalochale.R;
import com.blucore.cabchalochale.extra.DirectionFinder;
...
import static com.blucore.cabchalochale.Activity.MainActivity.tvHeaderText;
...
public class BookCabFragment extends Fragment implements OnMapReadyCallback,DirectionFinderListener, AdapterView.OnItemSelectedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.iv_menu.setOnClickListener(new View.OnClickListener() {
         ...
         Log.e("destination",""+destinations);
                ...
                try {
                    ...
                    if (JSNobject.getString("success").equalsIgnoreCase("true")) {
                        ...
                        track_Mylocation.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (Utils.isNetworkConnectedMainThred(getActivity())) {
                                    String start_lo=sources;
                                    String end_loc=destinations;
                                    Log.e("llll",""+start_lo);
                                    Log.e("dddd",""+end_loc);


                                    GetMyLocation(start_lo,end_loc);
    ...
    private void GetMyLocation(String start_lo, String end_loc) {

        try {
            Uri uri=Uri.parse("https://www.google.co.in/maps/dir/"+start_lo+"/"+end_loc);
