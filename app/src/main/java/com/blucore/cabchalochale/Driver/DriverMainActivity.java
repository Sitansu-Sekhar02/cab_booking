...
import com.blucore.cabchalochale.Activity.LoginActivity;
import com.blucore.cabchalochale.R;
import com.blucore.cabchalochale.extra.Preferences;
import com.google.android.material.navigation.NavigationView;

public class DriverMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        int id = menuItem.getItemId();
         if (id == R.id.nav_share) {
            ...
            String app_url = "https://play.google.com/store/apps/details?id=com.blucore.chalochalecab";
